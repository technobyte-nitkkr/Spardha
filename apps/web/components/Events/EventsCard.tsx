...
const EventsCard: React.FC<EventCardProps> = ({ image, eventName }) => {
  // Define other type from any ??
  return (
    <div
    ...
    >
      <Image
        alt=""
        className="absolute w-2/3 h-[max(25%,150px)] sm:h-2/5 md:h-[54%] lg:h-2/3 lg:w-[max(50%,600px)] xl:h-[65%] top-1/2 -translate-x-1/2 -translate-y-1/2 left-1/2"
        style={{
          clipPath:
