  ...
  <AnimatePresence>
    {isDrawerOpen && (
      ...
      >
        ...
        <Link className="block mb-4 text-lg text-white hover:text-gray-300" href="/#Sponsors" onClick={onClose}>
          Sponsors
        </Link>
        <Link className="block mb-4 text-lg text-white hover:text-gray-300" href="/#GuestLectures" onClick={onClose}>
          Lectures
        </Link>
        <Link className="block mb-4 text-lg text-white hover:text-gray-300" href={"/About"} onClick={onClose}>
          About
        </Link>
        <Link className="block text-lg text-white hover:text-gray-300" href={"/Teams"} onClick={onClose}>
          Teams
        </Link>
        <div className="mt-4">
          <Link
